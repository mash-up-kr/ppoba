...
function TaroCardBack({
  ...
  return (
    <motion.div
      ...
      className={`absolute w-full h-full top-0 left-0 rounded-[24px] flex justify-center items-center ${bgColor}`}
    >
      <motion.div
        initial={'hidden'}
        animate={isFlipped ? 'visible' : 'hidden'}
...
export default memo(TaroCardBack)
