...
const bgColors: string[] = Object.values(CardStyle).map(style => style.background);
    ...
    <div className="min-h-screen flex flex-col justify-between pb-[16px] bg-light">
      ...
      <div className='flex flex-col h-[calc(100vh-76px)] pt-[52px] justify-center'>
        <div className='mt-[60px] mx-[-24px]'>
          <Swiper
            scrollbar={{ draggable: true, el: '.swiper-scrollbar', hide: false }} slidesPerView={1.7} spaceBetween={16} centeredSlides modules={[Scrollbar]}
            className='pb-[50px]'
          >
